...
A static archive of the **Traveller_TNE** Yahoo! Group — a mailing list for *Traveller: The New Era* fans, active May 2005 – January 2020 — preserved as threaded, full-text-searchable posts after Yahoo Groups shut down in 2020.
...
make data    # regenerate data/posts.json + data/files.json from mail_archives/ (local only — not run in CI)
