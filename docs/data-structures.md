...
- Real date range (from `Date:` headers): **18 May 2005 – 8 Aug 2019** (one straggler dated 2020 in `From -` noise, not a real header). Yearly volume is uneven — heaviest in 2012 and 2014, thin in the early and final years.
